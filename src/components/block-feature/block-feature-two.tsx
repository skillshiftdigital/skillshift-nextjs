        ...
        <div className="row align-items-center">
          <div className="col-md-4">
            <div className="card-style-three pt-45 md-pt-30 pb-35 sm-pb-30">
              ...
              <h4 className="fw-bold mt-40 sm-mt-20 mb-20">Pay-as-you-go.</h4>
          ...
          <div className="col-md-5">
            <div className="border-line h-100 ps-lg-5 pe-lg-5 ps-md-3 pe-md-3">
              <div className="card-style-three pt-45 md-pt-30 pb-35 sm-pb-30">
                ...
                <h4 className="fw-bold mt-40 sm-mt-20 mb-20">Own and centralize your data.</h4>
                <p>Optimize expense tracking across platforms, & product lines using multiple cards.</p>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="ps-lg-5 sm-pb-30 sm-pt-30">
              <div className="numb fw-500"><span className="counter">12</span>+</div>
              <p className="m0">Search and Commerce Engines.</p>
            </div>
          </div>
        </div>
      </div>
