				...
				<div className="container">
					<div className="row">
						<div className="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
							<UpperCardItem icon={icon_2} title='People-first' subtitle='We want to pass you our knowledge and expertise.' />
						</div>
						<div className="col-lg-4 wow fadeInUp">
							<UpperCardItem icon={icon_1} title='Data-led' subtitle='We want to show you new ways of using data and technologies.' />
						</div>
						<div className="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
							<UpperCardItem icon={icon_3} title='Growth-oriented' subtitle='We want to help you grow and your business to thrive.' />
						</div>
					</div>
				</div>
				</div>}
            ...
            {service_items.map((item,i) => (
						<div key={i} className="col-lg-4 col-md-6 d-flex wow fadeInUp" data-wow-delay={`0.${i+1}s`}>
							<div className="card-style-two vstack tran3s w-100 mt-30">
								...
								<Link href={item.link} className="arrow-btn tran3s mt-auto stretched-link">
                  <Image src={arrow} alt="arrow" className="lazy-img"/>
					...
					<div className="section-subheading sm-mt-40">
						<p className="text-lg">We provide a range of services focused on helping digital businesses grow and thrive.</p>
