...
const WhoWeAre = ({cls,style_2}:{cls?:string;style_2?:boolean}) => {
  return (
    <>
        ...
        <div className="row">
          <div className="col-xxl-5 col-lg-6 ms-auto d-flex flex-column order-lg-last wow fadeInRight">
            <div className="title-one">
              <div className="upper-title">About skillshift</div>
              <h2>Who we are</h2>
            </div>
            <p className="text-lg mt-45 lg-mt-30 mb-35 lg-mb-30">
            We are a group of entrepreneurs who share the vision to enhance the way businesses conduct their business by providing them with the tools, the skills, the training and the experience to adapt, to build and to lead tomorrow&rsquo;s digital future.
            </p>
            <div>
