...
export default function HomePage() {
  return (
    <Wrapper>
      <Head>
        <title>seoShift - skillshift </title>
        <meta
          name="description"
          content="seoShift is the world's first pay-as-you-go SEO Software. The data you need, the insights you never knew you missed."
        />
      </Head>
